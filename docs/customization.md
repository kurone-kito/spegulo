...
| ------------------------------------------------------------------- | -------------------------------- |
| `idd-skill` in repo-name contexts                                   | `spegulo`                  |
| `idd-skill` in marker-prefix contexts (e.g. `idd-skill-roadmap-id`) | `spegulo`      |
| **fix-validate** command string                                     | `pnpm run lint:fix && pnpm run lint`      |
| **pre-push-validate** command string                                | `pnpm run lint` |
| **post-fix-validate** command string                                | `pnpm run lint:fix && pnpm run lint` |
...
- `audit-docs.mjs` enforces synchronization rules defined in
  `sync-manifest.json`
- Template copies use placeholders like `spegulo` to support
