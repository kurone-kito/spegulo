...
| -------------------------------- | --------------------------------------------------------- | ---------------------------------- |
| `spegulo`                  | Repository short name used in worktree examples           | `my-app`                           |
| `spegulo`      | Hidden issue-body marker prefix                           | `my-app`                           |
...
| `pnpm run lint` | Non-mutating verify command row                           | `npm run lint && npm run test`     |
| `pnpm run lint:fix && pnpm run lint` | Post-fix validate command row                             | `npm run lint:fix && npm test`     |
...
`spegulo` appears in two hidden issue-body markers:

- roadmap identity marker:
  `<!-- spegulo-roadmap-id: {unique-id} -->`
- blocked-by marker:
  `<!-- spegulo-blocked-by: {roadmap-id} -->`
